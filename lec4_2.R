...
# barplot은 히스토그램과 달리 범주형변수에 대한 빈도로 표시한다
par(mfrow=c(1,1))
table(cyl)
freq_cyl<-table(cyl)
...
# 회귀분석을 할때 독립변수들 간의 상관관계를 체크하기위해 pairwise로 산점도를 그려봄
...
# lm: linear model, y: mpg, x: wt , lwd: 직선 두께, lty: 라인타입
